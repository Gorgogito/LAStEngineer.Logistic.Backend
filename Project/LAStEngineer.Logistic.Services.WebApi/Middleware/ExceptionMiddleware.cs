using LAStEngineer.Logistic.Application.Validator.Exceptions;
using LAStEngineer.Logistic.Services.WebApi.Errors;
using Newtonsoft.Json;
using System.Net;

namespace LAStEngineer.Logistic.Services.WebApi.Middleware
{
